#!/usr/bin/env python
#-*- coding: iso-8859-1 -*-
#desarrollado en Vampy Security
import getopt
import time
import os
import sys
...
def usage():
    print("cc.py version pirata:{}".format(version))
    print("")
    print("\033[1;31m               +------------------------------+")
    print("               +\033[1;32m     GENERADOR DE Vampy Security     \033[1;31m+")
    print("               +------------------------------+")
    print("")
    print("+---------------+")
    ...
    print("+---------------+")
    print("")
    print("\033[1;36m     python2 cc.py -b     [Opciones de uso]")
    print("     python2 cc.py -h     Mensaje de ayuda")
    print("\033[1;31m")
    print("+-----------------+")
    ...
    print("")
    print("\033[1;36m     python2 cc.py -b 123456xxxxxxxxxx -u 40 -d -c ")
    print("")
    print("\033[1;31m")
    print("+---------------+")
    print("+\033[;32m Editado por Vampy\033[1;31m +")
    print("+---------------+\033[0m")
    print("")
    print("\033[1;33m Nickname: Vampy\033[0m")
    print("\033[1;33m Youtube: Vampy Security\033[0m")
    print("\033[1;33m Telegram: Hackers Undergrounds \033[0m")
    print("\033[1;33m Facebook: Radio Hack")
    print("")
